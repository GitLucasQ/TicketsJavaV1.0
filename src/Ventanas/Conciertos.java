...
public class Conciertos extends javax.swing.JFrame {
    ...
    private void cmbConciertosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbConciertosItemStateChanged
        ...
        switch (cmbConciertos.getSelectedIndex()) {
            ...
            case 1:
                ...
                break;
            case 2:
                cat.setRowFilter(RowFilter.regexFilter("Cumbia", 3));
                break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conciertos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Conciertos().setVisible(true);
            }
        });
