...
public class Teatro_Adm extends javax.swing.JFrame {
    ...
    public Teatro_Adm() {
        ...
        pt.listaEvento("DR001", "TE", "SAVIA", "Drama", "28/04/2018", "19:30 pm", "120 min", 45, 500, modeloTabla);
        pt.listaEvento("DR002", "TE", "La Tempestad", "Drama", "23/06/2018", "18:30 pm", "110 min", 105, 800, modeloTabla);
        pt.listaEvento("CM001", "TE", "Hasta la patas", "Comedia", "01/02/2018", "15:00 pm", "110 min", 40, 500, modeloTabla);
        pt.listaEvento("CM002", "TE", "SUDAKAS", "Comedia", "15/03/2018", "18:30 pm", "120 min", 45, 600, modeloTabla);
        pt.listaEvento("DA001", "TE", "Libertad D1", "Danza", "10/05/2018", "18:00 pm", "100 min", 55, 750, modeloTabla);
        pt.listaEvento("DA002", "TE", "Arborada", "Danza", "14/08/2018", "17:40 pm", "110 min", 60, 850, modeloTabla);
    }
    ...
    private void initComponents() {
        ...
        cmbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Comedia", "Danza", "Drama" }));
                ...
                if (!Numeros.precValido(txtprec.getText()) || Float.parseFloat(txtprec.getText()) <= 0) {
                    ...
                    if (!Numeros.esNumero(txttic.getText()) || Integer.parseInt(txttic.getText()) <= 0) {
                        ...
                        switch (cmbTipo.getSelectedIndex()) {
                            case 0:
                                pt.listaEvento("CM0" + numal, "TE", nombre, tipo, fecha, hora, duracion, precio, cantidad, modeloTabla);
                                break;
                            case 1:
                                pt.listaEvento("DA0" + numal, "TE", nombre, tipo, fecha, hora, duracion, precio, cantidad, modeloTabla);
                                break;
                            case 2:
                                pt.listaEvento("DR0" + numal, "TE", nombre, tipo, fecha, hora, duracion, precio, cantidad, modeloTabla);
                                break;
                        }                  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teatro_Adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Teatro_Adm().setVisible(true);
            }
        });
