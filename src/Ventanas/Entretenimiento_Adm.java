...
public class Entretenimiento_Adm extends javax.swing.JFrame {
    ...
    public Entretenimiento_Adm() {
        ...
        pt.listaEvento("FI001", "ENT", "Fiesta Blanca Año Nuevo", "Fiesta", "29/12/2017", "21:30 pm", "120 min", 45, 500, modeloTabla);
        pt.listaEvento("FI002", "ENT", "Fiesta Año Nuevo", "Fiestas", "31/12/2017", "21:30 pm", "110 min", 105, 800, modeloTabla);
        pt.listaEvento("FI003", "ENT", "Urban Party", "Fiestas", "29/10/2017", "22:30 pm", "100 min", 55, 800, modeloTabla);
        pt.listaEvento("PE001", "ENT", "Almuerzo Show", "Peñas", "15/03/2018", "13:20 pm", "120 min", 39, 600, modeloTabla);
        pt.listaEvento("PE002", "ENT", "Folclor en la Candelaria", "Peñas", "24/01/2018", "18:00 pm", "90 min", 45, 750, modeloTabla);
        pt.listaEvento("PE003", "ENT", "Peña Criolla", "Peñas", "17/09/2018", "13:40 pm", "110 min", 60, 850, modeloTabla);
        pt.listaEvento("TO001", "ENT", "Tour del Miedo - Cementerio", "Tours", "07/04/2018", "20:40 pm", "70 min", 40, 800, modeloTabla);
        pt.listaEvento("TO002", "ENT", "Laguna Huacachina", "Tours", "07/04/2018", "20:40 pm", "70 min", 40, 800, modeloTabla);
    }
    ...
    private void initComponents() {
        ...
        cmbConciertos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fiestas", "Peñas", "Tours" }));
        ...
        cmbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fiestas", "Peñas", "Tours" }));
    ...
    private void cmbConciertosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbConciertosItemStateChanged
        ...
        switch (cmbConciertos.getSelectedIndex()) {
            case 0:
                cat.setRowFilter(RowFilter.regexFilter("Fiestas", 3));
                break;
            case 1:
                cat.setRowFilter(RowFilter.regexFilter("Peñas", 3));
                break;
            case 2:
                cat.setRowFilter(RowFilter.regexFilter("Tours", 3));
                break;
        }
                ...
                if (!Numeros.precValido(txtprec.getText()) || Float.parseFloat(txtprec.getText()) <= 0) {
                    ...
                    if (!Numeros.esNumero(txttic.getText()) || Integer.parseInt(txttic.getText()) <= 0) {
                        ...
                        switch (cmbTipo.getSelectedIndex()) {
                            case 0:
                                pt.listaEvento("FI0" + numal, "ENT", nombre, tipo, fecha, hora, duracion, precio, cantidad, modeloTabla);
                                break;
                            case 1:
                                pt.listaEvento("PE0" + numal, "ENT", nombre, tipo, fecha, hora, duracion, precio, cantidad, modeloTabla);
                                break;
                            case 2:
                                pt.listaEvento("TO0" + numal, "ENT", nombre, tipo, fecha, hora, duracion, precio, cantidad, modeloTabla);
                                break;
                        }                  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Entretenimiento_Adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Entretenimiento_Adm().setVisible(true);
            }
        });
